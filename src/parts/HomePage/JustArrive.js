...
import Carousel from '../../components/BreadCrumb/Carousel/Carousel';
							...
							return (
								<div className="px-4 relative card group" key={item.id}>
									<div
										...
										style={{ width: 287, height: 386 }}
									>
										<div className="absolute opacity-0 group-hover:opacity-100 transition duration-200 flex items-center justify-center w-full h-full bg-black bg-opacity-70">
